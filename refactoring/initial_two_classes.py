...
class Group:
    ...
    def number_of_connections(self, name):
        ...
        assert self.contains(name), "Person not part of group!"
    ...
    def connect(self, name1, name2, relation, reciprocal=True):
        ...
        """
        assert self.contains(name1), "Person 1 not part of group!"
        assert self.contains(name2), "Person 2 not part of group!"
